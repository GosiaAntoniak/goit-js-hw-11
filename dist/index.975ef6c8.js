...
const searchImagesValue = ()=>{
    (0, _fetchImages.fetchImages)(input.value, pageNumber).then((photos)=>{
        if (pageNumber < 1) gallery.innerHTML = "";
...
function renderImages(photos) {
    ...
    if (pageNumber <= 1) {
        ...
        } else (0, _notiflixDefault.default).Notify.success(`Found ${photos.totalHits} images`);
    }
    photos.hits.forEach(({ webformatURL , largeImageURL , tags , likes , views , comments , downloads  })=>{
...
},{"./sass/main.scss":"dFl68","notiflix":"5WWYd","./fetchImages":"8Bjl1","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","simplelightbox":"9ydBq"}],"dFl68":[function() {},{}],"5WWYd":[function(require,module,exports) {
var global = arguments[3];
...
},{}],"8Bjl1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchImages", ()=>fetchImages);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
async function fetchImages(searching, page) {
    try {
...
},{"./../utils.js":"5By4s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kaxSc":[function() {},{}],"9ydBq":[function(require,module,exports) {
/*!
